...
function enqueue_theme_stylesheets()
{
    ...
    wp_register_style('reset', get_template_directory_uri() . '/assets/css/reset.css', '', null, 'all');
    wp_register_style('wp-core', get_template_directory_uri() . '/assets/css/wp-core.css', '', null, 'all');
